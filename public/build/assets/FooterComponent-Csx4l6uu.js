    ...
    async rebuildStocks() {
      ...
      this.stocks = (await Promise.all(this.globalFormattedStocks.map(async (stock) => {
        ...
        if (stock.vwap == null) {
          ...
          if (this.latestVWAPCache[stock.sym] !== void 0) {
        ...
        const effectiveVWAP = latest_vwap ?? stock.vwap ?? (existing == null ? void 0 : existing.vwap) ?? null;
...
const LiveStocksTable = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-d60ef7bb"]]);
